import{S as k,i as y,d as g,s as q,v,p as c,q as p,r as u,l as r,x as m,g as w,I as C,J as s}from"../chunks/index.74d5b8c7.js";const f=`<h1>Table of Contents</h1>
<ol>
...
`,x=[{level:"1",content:"Table of Contents"},{level:"1",content:"Basic"},{level:"2",content:"Basic configurations for functionality"},{level:"2",content:"Packages config"},{level:"2",content:"Custom variables"},{level:"1",content:"Functional"},{level:"2",content:"Evil"},{level:"2",content:"evil-nerd-commenter"},{level:"2",content:"undo-fo and undo tree"},{level:"2",content:"Rainbow mode"},{level:"2",content:"Which key"},{level:"2",content:"Auto-complete"},{level:"2",content:"NeoTree"},{level:"2",content:"Centaur tabs - OFF"},{level:"2",content:"Flycheck syntax checker"},{level:"2",content:"Helm - OFF"},{level:"2",content:"Ivy - OFF"},{level:"3",content:"Ivy-rich - OFF"},{level:"2",content:"Vertigo"},{level:"2",content:"Marginalia"},{level:"2",content:"Rainbow delimiter"},{level:"2",content:"Projectile"},{level:"3",content:"Counsel"},{level:"2",content:"Magit"},{level:"2",content:"Helpful"},{level:"2",content:"Dash Board"},{level:"2",content:"Lorem ipsom"},{level:"1",content:"Appearance"},{level:"2",content:"All the icons"},{level:"2",content:"Doom Themes"},{level:"2",content:"Doom modeline"},{level:"2",content:"Page Breaking"},{level:"2",content:"Fonts"},{level:"1",content:"Programming"},{level:"2",content:"lsp-mode&apos;"},{level:"3",content:"lsp-ui"},{level:"3",content:"lsp-treeemacs"},{level:"2",content:"dap-mode ( Debug Adapter Protocol)"},{level:"2",content:"Company-mode"},{level:"2",content:"Elisp"},{level:"3",content:"ParaEdit"},{level:"2",content:"Org"},{level:"3",content:"Basic Config"},{level:"3",content:"Centraliza o texto org mode"},{level:"3",content:"Add templets for the extencions .el, .py &#x2026;"},{level:"3",content:"Babel to load"},{level:"3",content:"Tangle automatic"},{level:"3",content:"Org Agenda"},{level:"3",content:"Customization"},{level:"3",content:"Org Roam"},{level:"3",content:"Change the sizes of the headers"},{level:"3",content:"Add the markdown to the org export"},{level:"2",content:"Python"},{level:"3",content:"Python mode"},{level:"2",content:"JS- Not useful since I have the web mode"},{level:"3",content:"RJSX"},{level:"3",content:"Tide"},{level:"2",content:"Typescript"},{level:"2",content:"web-mode"},{level:"3",content:"Prettier"},{level:"2",content:"CSS/SCSS-mode"},{level:"2",content:"JSON-mode"},{level:"2",content:"yalm-mode"},{level:"2",content:"svelte-mode"},{level:"2",content:"Dockerfile-mode"},{level:"2",content:"Rust-mode"},{level:"2",content:"format-all"},{level:"2",content:"YASnippet"},{level:"1",content:"Update packages"},{level:"1",content:"Key Binds"},{level:"2",content:"Evil colemakeDH"},{level:"2",content:"org-babel-tange"},{level:"2",content:"flyspell, ispell"},{level:"3",content:"flyspelll-prog-mode key binding"},{level:"3",content:"flyspell-key-mode binding"},{level:"3",content:"Ispell comments and strings key binding"},{level:"3",content:"Ispell key binding"},{level:"1",content:"Test area"}],h="src/routes/blog/my-emacs/+page.svelte";function d(i){let e,n;const l={c:function(){e=c("main"),n=c("article"),this.h()},l:function(o){e=p(o,"MAIN",{});var t=u(e);n=p(t,"ARTICLE",{});var b=u(n);b.forEach(r),t.forEach(r),this.h()},h:function(){m(n,h,6,2,98),m(e,h,5,0,89)},m:function(o,t){w(o,e,t),C(e,n),n.innerHTML=f},p:s,i:s,o:s,d:function(o){o&&r(e)}};return g("SvelteRegisterBlock",{block:l,id:d.name,type:"component",source:"",ctx:i}),l}function S(i,e,n){let{$$slots:l={},$$scope:a}=e;v("Page",l,[]);const o=[];return Object.keys(e).forEach(t=>{!~o.indexOf(t)&&t.slice(0,2)!=="$$"&&t!=="slot"&&console.warn(`<Page> was created with unknown prop '${t}'`)}),i.$capture_state=()=>({toc:x,html:f}),[]}class j extends k{constructor(e){super(e),y(this,e,S,d,q,{}),g("SvelteRegisterComponent",{component:this,tagName:"Page",options:e,id:d.name})}}export{j as default};
